...
class PrettyWidget(QtGui.QWidget):
    ...
    def SingleBrowse(self):
        video_path = QtGui.QFileDialog.getOpenFileName(self,
                                                        'Single File', "/home/tienthanh/Desktop/data/videos_testing")
        ...
        FeaturePath = FeaturePath+ '_layer_000006.txt'
        ...
        for iv in range(0, 32):
            ...
            F_Score = np.ones((1, (int(total_segments[iv+1])-int(total_segments[iv]))))
            for j in range(int(total_segments[iv+1])-int(total_segments[iv])):
              F_Score[0][j] = predictions[iv]
            count = count + 1
            if count == 0:
        ...
        while True:
            ...
            if flag:
                ...
                if jj==1:
                    ...
                    plt.draw()
                    if i >= Total_frames - 27 and save == True:
                        print("start save")
                        save = False
                    name = '/home/tienthanh/Downloads/AnomalyDetectionCVPR2018-master/weight/' + video_path.split('/')[-1] 
                    print(name)
                    
                        
                    plt.pause(0.000000000000000000000001)
                    plt.suptitle(video_path.split('/')[-1])
